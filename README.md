...
4. **Configure the Front-End:**
    - Inside your Ed workspace where your server is being hosted, copy the URL generated by the Ed workspace.
    - Paste this inside the front-end `config.json` file under the key `url`.
